...
- **Palette:** Cinder and Ember approved. Core roles: cutting-room graphite `#141519`; projector white `#F3EFE6`; ember `#F06A45`; steel blue `#7FA8BC`; restrained brass `#D0A64B`. Main pairings pass WCAG AA for normal text (projector white 15.9:1, ember 5.95:1, steel 7.15:1, and brass 8.03:1 against graphite). **Additional finding (2026-09-24), computed not assumed:** against the light surface (projector white as background), none of the three accents clear even 3:1 (ember 2.67:1, steel 2.22:1, brass 1.98:1) — they may only be used as a fill behind dark text on light sections (same pair, reversed roles, ~6-8:1), never as standalone text/border/icon color on light. **Text-safe tints added (2026-09-24):** `--color-accent-on-light` (`#A84A30`, ember darkened to 70% brightness, 4.96:1) and `--color-accent-secondary-on-light` (`#4C6470`, steel darkened to 60% brightness, 5.44:1) — same hues, darkened just enough to clear 4.5:1, for accent-colored text specifically on the light surface (e.g. the Capabilities section's numbered index, which alternates the two per client request).
